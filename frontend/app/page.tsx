          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <MuiGrid container spacing={6} alignItems="center">
              ...
              <MuiGrid sx={{ mb: { xs: 4, md: 0 } }}>
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{
                      fontSize: { xs: '2.5rem', md: '3.5rem' },
                      lineHeight: 1.2,
                      background: 'linear-gradient(to right, #fffc33, #ff77FF)',
                      WebkitBackgroundClip: 'text',
                      WebkitTextFillColor: 'transparent',
                    }}
                  >
                    Resident Nerd & Game Dev
                  </Typography>
                </Typography>
                <Typography 
                  variant="h6" 
                ...
                >
                  I create fun games that i belive many should be able to enjoy
                </Typography>
